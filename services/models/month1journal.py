...
class Month1Journal(models.Model):
    '''Work Mounthly Journal Праздничные дни'''
    class Meta:
        verbose_name = u'Месячный график дежурств по праздникам'
        verbose_name_plural = u'Месячные журналы по праздникам'
